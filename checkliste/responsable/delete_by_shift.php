                ...
                <div class="table-container">
                    ...
                    <table class="table datatable-responsive">
                        ...
                        <tbody>
                            ...
                            $sql1 = "SELECT id, responsable, shift, datet, nom, matricule, nom_ligne, check_status, valeur_min, valeur_max, valeur, parameter, nom_lig, projetl FROM check_form1 WHERE responsable = '$username'";
                            ...
                            if ($result1->num_rows > 0) {
                                ...
                                while ($row = $result1->fetch_assoc()) {
                                    ...
                                    if ($previousRow !== null) {
                                        ...
                                        echo "<td><a class='btn btn-danger' href='delete.php?datet=" . $previousRow['datet'] . "&shift=" . $previousRow['shift'] . "&projetl=" . $previousRow['projetl'] . "'>Delete</a></td>";
                                        echo "</tr>";
                                    }
