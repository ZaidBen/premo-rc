                ...
                <div class="table-container">
                    ...
                    <table class="table datatable-responsive">
                        ...
                        <tbody>
                            ...
                            $sql1 = "SELECT id, responsable, shift, datet, nom, matricule, nom_ligne, check_status, valeur_min, valeur_max, valeur, parameter, nom_lig, projetl FROM check_form1 WHERE responsable = '$username' ORDER BY id ASC";
                            ...
                            if ($result1->num_rows > 0) {
                                ...
                                while ($row = $result1->fetch_assoc()) {
                                    ...
                                    if ($previousRow !== null) {
                                        echo "<tr onclick=\"window.location='listtable.php?projetl=" . $previousRow['projetl'] . "&datet=" . $previousRow['datet'] . "&shift=" . $previousRow['shift'] . "&nom_lig=" . $previousRow['nom_lig'] . "'\">";
