...
$sql1 = "SELECT * FROM postes_parameters where poste_id ='$id' ORDER BY id DESC";
			...
			<div class="content-inner">
				<div class="col-xl-12">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<a href="../parametres/addpp.php?id=<?php echo $id; ?>" class="btn btn-outline-primary">Nouveau
								Parametre</a>
						</div>
					</div>
					<div class="card">
